...
const Gallery = () => {
  return (
    <>
      <PageHero
        title="Galeria"
        description="Aktualne zdjęcia i klimat z wody znajdziesz na Instagramie."
      ...
      <section className="px-3 pb-12 md:px-4 md:pb-16">
        <div className="container mx-auto space-y-8 md:space-y-10">
          ...
          <a
            ...
            className="mx-auto flex min-h-16 w-full max-w-[500px] items-center justify-center gap-3 rounded-full border border-[rgba(255,255,255,0.16)] bg-[#384958] px-6 py-4 text-center font-heading text-[0.88rem] font-semibold tracking-[-0.03em] text-white shadow-[0_18px_50px_rgba(14,26,37,0.32)] transition-transform duration-300 hover:-translate-y-0.5 hover:bg-[#415465] md:min-h-20 md:gap-4 md:px-8 md:py-5 md:text-2xl"
